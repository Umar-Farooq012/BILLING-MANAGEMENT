...
--   Date and Time:   10:28 Wednesday February 28, 2024
--   Exported By:     UMAR
--   Flashback:       40
...
,p_last_upd_yyyymmddhh24miss=>'20240227194032'
);
...
'       DBS.PREV_READING,',
'       DBS.METER_REF_NO,',
'       DBS.BILLS_DETAILS_ID,',
'       DBS.CURRENT_READING,',
'       DBS.BILL_PAYMENT,',
'       DBS.UNIT_CONSUMED',
'',
'  from DGMS_BILLS_SETUP DBS',
'WHERE BILLS_DETAILS_ID=:P175_ID',
'',
'  ',
'',
'',
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(241866903804322937)
,p_name=>'BILLS_DETAILS_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BILLS_DETAILS_ID'
,p_data_type=>'NUMBER'
,p_is_query_only=>false
,p_item_type=>'NATIVE_NUMBER_FIELD'
,p_heading=>'Bills Details Id'
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(242758488435162556)
,p_view_id=>wwv_flow_api.id(241869391480322642)
,p_display_seq=>2
,p_column_id=>wwv_flow_api.id(241866903804322937)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
...
'--     DPD.PLOT_NO||'' - ''|| DBS.CUSTOMER_NAME ||'' (''|| DBR.LIVING_STATUS ||'' - ''|| DBS.METER_REF_NO ||'' - ''|| DBS.PORTION ||'')'' AS D,',
'--     DBS.ID AS R',
'-- FROM DGMS_BILLS_SETUP  DBS',
...
'SELECT',
'    DPD.PLOT_NO,',
'    DPB.CLIENT_REG_NO,DBS.PLOT_ID,',
'    DPD.PLOT_NO || '' - '' || DPB.CLIENT_REG_NO || '' '' || DBS.PLOT_ID AS D,',
'    DPD.ID AS R',
'FROM',
'    DGMS_PLOT_DETAILS DPD',
'    LEFT JOIN DGMS_PLOTS_BOOKING DPB ON DPB.PLOT_ID = DPD.ID AND DPD.ORG_ID = :P175_ORGANIZATION',
'    LEFT JOIN DGMS_BILLS_SETUP DBS ON DBS.PLOT_ID = DPB.PLOT_ID; '))
...
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_api.id(174382427556141889)
,p_prompt=>'Marla Category'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC:5 MARLA;5,10 MARLA;10,15 MARLA;15,20 MARLA;20'
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(158420883850282999)
,p_item_template_options=>'#DEFAULT#'
...
,p_attribute_03=>'P175_METER,P175_PREV_READING,P175_ARREARS,P175_PLOT_ID1,P175_PAYABLE,P175_PAYABLE_AFTER_DUE_DATE,P175_UNIT_CONSUMED,P175_U_ID,P175_MONTH,P175_BILL_SU_C_ID,P175_TARIFF_PER_UNIT,P175_PREVIOUS_READING1,P175_PREVIOUS_READING2,P175_SUM_OF_CONSUMED_UNITS'
,p_attribute_04=>'Y'
...
||'DING1,P175_CONSUMED_UNITS1,P175_CURRENT_READING2,P175_PREVIOUS_READING2,P175_CONSUMED_UNITS2,P175_WASA_CHARGES,P175_BILL'
);
wwv_flow_api.create_page_da_event(
...
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'apex.region( "c_type" ).widget().interactiveGrid( "getActions" ).invoke( "selection-add-row" );'
);
wwv_flow_api.create_page_da_action(
...
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'apex.region("c_type").call("getActions").set("edit", true);'
);
end;
/
begin
...
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select prev_reading from dgms_bills_setup',
'where METER_REF_NO = :METER_REF_NO'))
,p_attribute_07=>'METER_REF_NO'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
...
'         insert into DGMS_BILLS_SETUP ( METER_REF_NO, PREV_READING, PLOT_ID , BILLS_DETAILS_ID , CURRENT_READING, UNIT_CONSUMED, BILL_PAYMENT)',
'         values ( :METER_REF_NO, :PREV_READING,	:PLOT_ID,	:P175_ID, :CURRENT_READING, :UNIT_CONSUMED, :BILL_PAYMENT)',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(227236772065843018)
,p_process_sequence=>60
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(239587083110541426)
,p_process_type=>'NATIVE_IG_DML'
,p_process_name=>'grid details - Save Interactive Grid Data'
